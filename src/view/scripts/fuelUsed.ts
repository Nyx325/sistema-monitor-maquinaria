...
class FuelUsedView {
  ...
  private modal: Modal;
  private table: Table<FuelUsedWithSnapshot>;
  private adapter: Adapter = new Adapter("combustibleUsado");
  ...
  private async initTable() {
    this.table.setTitle("Combustible usado");
  ...
  private async refreshTable() {
    ...
    const search: Search<FuelUsedWithSnapshot> = JSON.parse(
      await response.text(),
    );
