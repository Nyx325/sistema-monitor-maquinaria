import { DefRemainingWithSnapshot } from "../../model/entities/ModelsWithSnapshot.js";
import { View } from "./view.js";

class DEFRemainingView extends View<DefRemainingWithSnapshot> {
  constructor() {
    super({
      adapterEndpoint: "DEFRestante",
      alert: "alert",
      modalId: "modal",
      tableId: "records",
      legend: "form-title",
  ...
  protected initForm(): void {
    ...
    this.form.aceptBtn.addEventListener("click", async () => {
      ...
      if (this.form.adding) {
        ...
        fuel = {
          def_remaining_id: selected.def_remaining_id,
          date_time,
          percent,
          active,
  ...
  protected updateBtnAction(record: DefRemainingWithSnapshot) {
    const i = this.form.inputs;
  ...
  protected getRecordId(record: DefRemainingWithSnapshot) {
    return record.def_remaining_id;
  }
}

document.addEventListener("DOMContentLoaded", () => {
  new DEFRemainingView();
});
