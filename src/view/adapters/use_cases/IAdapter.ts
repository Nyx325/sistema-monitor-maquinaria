 ...
 */
export interface IAdapter<M, NM, I> {
  /**
   ...
   * @returns Una promesa que resuelve con la respuesta de la API.
   */
  delete(model: M): Promise<Response>;
   ...
   * @returns Una promesa que resuelve con la respuesta de la API.
   */
  update(model: M): Promise<Response>;
   ...
   * @returns Una promesa que resuelve con la respuesta de la API.
   */
  getBy(criteria: Partial<M>, pageNumer: number): Promise<Response>;
